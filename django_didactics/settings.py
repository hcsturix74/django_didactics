...
# Django settings for enricop project.
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_PATH, 'didactics.sqlite'), # Or path to database file if using sqlite3.
...
SECRET_KEY = 'z*iku=y&7934isbxqwmjxort@!h)*k)^yqlksuqlni#vh#mq1l'
...
WSGI_APPLICATION = 'django_didactics.wsgi.application'
